...
public class IMMsgBeanMutli {
    ...
    public IMMsgBeanMutli() {
    }

    public IMMsgBeanMutli(Integer syncOtherMachine, JSONArray to_Account, Integer msgLifeTime, Integer msgRandom, long msgTimeStamp, JSONArray msgBody) {
    ...
    public JSONArray getTo_Account() {
        return To_Account;
    }

    public void setTo_Account(JSONArray to_Account) {
        To_Account = to_Account;
    }
